	...
	<div class="links">
		<div class="aa">
			<div class="ads_300">
				...
				<iframe src="<?php echo DOO_GGL; echo DOO_728; ?>" width="300" height="250" frameborder="0" scrolling="no" allowtransparency="true"></iframe>
			</div>
		</div>
		<div class="bb">
			<h1><?php echo $tipo, ' - ', $title, ' (', $calidad, ')'; ?></h1>
			 <div class="ads_468">
				...
				<iframe src="<?php echo DOO_GGL; echo DOO_468; ?>" width="468" height="60" frameborder="0" scrolling="no" allowtransparency="true"></iframe>
			 </div>
