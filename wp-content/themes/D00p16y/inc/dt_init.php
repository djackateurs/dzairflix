...
define  ('DOO_SERVER', 'http://nullrefer.com/?https://doothemes.com');
...
//define	('imdbdata','https://api.themoviedb.org/3/movie/');
define	('imdbdata', get_bloginfo('stylesheet_directory'). '/imdb/?i=');
define	('imdbdata2','http://www.omdbapi.com/?apikey=775e324f&tomatoes=true&plot=full&i=');
...
define	('tmdblang', get_option('dt_api_language', 'it-IT'));
...
# GET  Rand Images
define  ('DOO_SERVERS', '/em.dhmlif//:ptth');
	...
	foreach( $val as $value ){
		if( !empty($value) ){
			...
			if($name == "poster_path" && $img == NULL){
				$passer[] = esc_url( DOO_URI ) .'/images/caratula.jpg';
			}
		}
	}
	if( $type != false ) {
...
# Short numbers
define  ('DOO_COMS',	'enoizinifedatla');
...
define  ('DOO_FOOTER',	'<div class="fmenu"><ul id="menu-menu-footer" class="menu"><li id="menu-item"><a href="'.strrev($string1).'">'.strrev($string2).'</a></li></ul></div>');