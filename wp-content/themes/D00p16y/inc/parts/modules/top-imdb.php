...
<div class="top-imdb-item" id="top-<?php the_id(); ?>">
	<div class="image"><div class="poster"><a href="<?php the_permalink(); ?>"><img src="<?php if($thumb_id) { echo $thumb_url[0]; } else { dt_image('dt_poster', $post->ID, 'w90'); } ?>" alt="<?php the_title(); ?>" /></a></div></div>
