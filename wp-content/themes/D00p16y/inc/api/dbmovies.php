...
<div id="dt_importer" class="dt_importer_wrap">
	<header class="dt_importer">
		<div class="box">
			<h1><a href="http://nullrefer.com/?https://dbmovies.org" target="_blank"><img src="<?php echo DT_DIR_URI; ?>/assets/img/dbmovies.png"></a> <i>Status code</i> <span class="fa fa-circle" style="color:#8be71f;"></span></h1>
		</div>
